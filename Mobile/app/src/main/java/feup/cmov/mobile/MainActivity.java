...
public class MainActivity extends AppCompatActivity {
    ...
    void testPreferences() throws JSONException {
        ...
        Product product4 = new Product("quatro", 12.3f);
        Product product5 = new Product("cinco", 15.6f);
        Product product6 = new Product("seis", 11.5f);
        Product product7 = new Product("sete", 12.3f);
        Product product8 = new Product("oito", 15.6f);
        Product product9 = new Product("nove", 11.5f);
        Product product10 = new Product("dez", 12.3f);
        Product product11 = new Product("onze", 15.6f);
        Product product12 = new Product("doze", 11.5f);
        Product product13 = new Product("treze", 12.3f);
        basket.add(product1);
        basket.add(product2);
        basket.add(product3);
        basket.add(product4);
